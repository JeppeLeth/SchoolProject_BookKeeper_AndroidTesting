...
public class MainActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TypedArray typedArray = getResources().obtainTypedArray(
				R.array.menu_array_icons);
		final Drawable[] menuIcons = new Drawable[] {
		...
		// add all items
		ArrayAdapter<?> listadaptor = new ArrayAdapter<Object>(this,
			...
			public View getView(int position, View convertView,
				...
				if (convertView == null) {
					convertView = LayoutInflater.from(getBaseContext())
							.inflate(R.layout.drawer_list_item, container,
									false);
				}
				TextView title = (TextView) convertView;
				title.setText(mMenuTitles[position]);
				title.setCompoundDrawablesWithIntrinsicBounds(
						menuIcons[position], null, null, null);
				return convertView;
			}
		};
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		...
		Toast toast = Toast.makeText(this, R.string.no_data_received, Toast.LENGTH_SHORT);
		toast.show();
	}
