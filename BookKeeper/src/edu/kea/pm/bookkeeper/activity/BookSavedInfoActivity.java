...
public class BookSavedInfoActivity extends FragmentActivity implements
		BookSavedInfoFragmentController {
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		menu.removeItem(TextUtils.isEmpty(mBook.getLoaner()) ? R.id.action_loan_status_remove
				: R.id.action_loan_status_add);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_loan_status_add:
			...
			bundle.putString(LoanerPopupFragment.BUNDLE_LOANER_TEXT,
					mBook.getLoaner());
		...
		case R.id.action_loan_status_remove:
			Toast.makeText(this, R.string.loaner_removed, Toast.LENGTH_LONG)
					.show();
