...
public class LoanerPopupFragment extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// grabs string tagged 'loaner' from bundle
		String loaner = bundle.getString(BUNDLE_LOANER_TEXT, "");
		getDialog().setTitle(R.string.enter_loaner);

		View view = inflater.inflate(R.layout.loaner_popup, container);
		this.loaner_EditText = (EditText) view.findViewById(R.id.loaner_text);
		this.loaner_EditText.setText(loaner);
		this.loaner_EditText.setSelection(0, loaner_EditText.length());
		this.loaner_EditText
				.setOnEditorActionListener(new OnEditorActionListener() {
					...
					public boolean onEditorAction(TextView v, int actionId,
						...
						if (actionId == EditorInfo.IME_ACTION_DONE
								&& listener != null) {
							listener.onOK(loaner_EditText.getText().toString()
									.trim());
		...
		Button okButton = (Button) view.findViewById(android.R.id.button1);
