...
public class BookSavedInfoFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_book_info_status,
				container, false);
	...
	public void updateBook() {
		...
		mStatus.setImageResource(loanedOut ? R.drawable.book_green
				: R.drawable.book_red);
		...
		mPublished.setText(!TextUtils.isEmpty(book.getPublished()) ? book
				.getPublished() : noInfo);
		mComment.setText(!TextUtils.isEmpty(book.getComment()) ? book
				.getComment() : noInfo);
		mLoaner.setText(!TextUtils.isEmpty(book.getLoaner()) ? book.getLoaner()
				: noInfo);
	...
	public void onAttach(Activity activity) {
		...
		try {
			...
			throw new ClassCastException(activity.toString()
					+ " must implement "
					+ BookSavedInfoFragmentController.class.getSimpleName());
		}
	}
